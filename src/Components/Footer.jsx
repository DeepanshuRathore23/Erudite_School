...
function Footer() {
    return (
        <>
            <div className="footer bg-[#4d4d4d] w-full mt-20 pt-10 px-6 text-white flex flex-wrap lg:flex-nowrap">
                
                {/* Logo and About Section */}
                <div className="w-full lg:w-1/4 m-2 flex flex-col items-center lg:items-start">
                    <div className="school-logo">
                        <img src={schoolLogo} alt="" className="h-24 w-24 lg:h-24 lg:w-24" />
                    </div>
                ...
                <div className="w-full lg:w-1/4 m-2 text-center lg:text-left">
                    ...
                    <Link to="/about" className="hover:text-[#d59f0f] transition-colors duration-300 block my-2">About TEWS</Link>
                    <div className="line h-px bg-gray-500 my-4"></div>
                    <Link to="/admissions" className="hover:text-[#d59f0f] transition-colors duration-300 block my-2">Admissions</Link>
                    <div className="line h-px bg-gray-500 my-4"></div>
                    <Link to="/academics" className="hover:text-[#d59f0f] transition-colors duration-300 block my-2">Academics</Link>
                    <div className="line h-px bg-gray-500 my-4"></div>
                    <Link to="/studentLife" className="hover:text-[#d59f0f] transition-colors duration-300 block my-2">Student Life</Link>
                    <div className="line h-px bg-gray-500 my-4"></div>
                    <Link to="/athletics" className="hover:text-[#d59f0f] transition-colors duration-300 block my-2">Athletics</Link>
