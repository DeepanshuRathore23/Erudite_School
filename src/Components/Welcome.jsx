...
function Welcome() {
    ...
    return (
        <>
            <div className="main flex flex-col lg:flex-row p-3 overflow-hidden items-center lg:items-start">
                
                {/* Left Section: Image */}
                <div className={`left w-full lg:w-2/5 p-5 lg:pl-5 lg:ml-5 duration-1000 ${scrolled ? 'translate-x-0' : '-translate-x-full'}`}>
                    <img src={WelcomeStudent} alt="Welcome Student" className="w-full h-auto lg:h-4/5 mt-4" />
                </div>
